  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-background via-background to-background/50 pt-20">
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-primary/3 rounded-full blur-3xl animate-pulse delay-2000"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="space-y-8">
          <div className="inline-flex items-center px-4 py-2 bg-primary/10 border border-primary/30 rounded-full text-sm text-primary backdrop-blur-sm">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto mt-12">
            {[
              ...
              <div
                key={index}
                className="group p-4 md:p-6 bg-card/40 border border-primary/20 rounded-lg hover:bg-card/60 hover:border-primary/40 transition-all duration-300 hover:scale-105 backdrop-blur-sm"
              >
                <pillar.icon className="w-6 h-6 md:w-8 md:h-8 text-primary mx-auto mb-3 group-hover:scale-110 transition-transform" />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-12">
            <Button
              size="lg"
              className="bg-primary hover:bg-primary/90 text-primary-foreground font-medium px-8 py-4 text-base md:text-lg transition-all duration-200 shadow-lg hover:shadow-primary/50 hover:shadow-xl"
            >
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-primary/30 hover:bg-primary/10 hover:border-primary/50 px-8 py-4 text-base md:text-lg bg-transparent text-foreground transition-all duration-200"
            >
          ...
          <div className="mt-16 pt-8 border-t border-primary/20">
            ...
            <div className="flex flex-wrap justify-center items-center gap-4 md:gap-8 opacity-70">
              {["Enterprise", "Startups", "E-commerce", "SaaS", "FinTech"].map((industry) => (
                <div
                  key={industry}
                  className="px-3 md:px-4 py-2 bg-primary/5 border border-primary/20 rounded text-xs md:text-sm text-muted-foreground hover:text-primary transition-colors backdrop-blur-sm"
                >
                  {industry}
                </div>
              ))}
